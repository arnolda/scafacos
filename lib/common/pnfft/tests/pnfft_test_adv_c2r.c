...
static void vpr_real(
    MPI_Comm comm, ptrdiff_t num, double *vec, const char *info);
...
//   pnfft = pnfft_init_3d(N local_M, comm_cart_3d);
  pnfft = pnfft_init_adv_c2r(3, N, local_M,
...
//       PNFFT_WINDOW_BSPLINE| PNFFT_MALLOC_X| PNFFT_MALLOC_F_HAT| PNFFT_MALLOC_F, PFFT_ESTIMATE,
  ...
  init_input_c2r_3d(N, local_N, local_N_start,
      f_hat);
