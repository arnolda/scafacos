...
int main(int argc, char **argv)
{
  ...
  pnfft_create_procmesh(3, MPI_COMM_WORLD, np, &comm_cart_3d_c2r);
...
//  pnfft_vpr_complex(f_c2c, local_M, "PNFFT, f", MPI_COMM_WORLD);
  ...
  double err;
  err = compare_complex_real(local_N_c2r, f_c2c, f_c2r, comm_cart_3d_c2r);
